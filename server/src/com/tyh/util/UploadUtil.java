...
public class UploadUtil
{
	...
	public void uploadImage1(HttpServletRequest request,MultipartFile file, String getUploadContentType, String getUploadFileName) throws IOException
	{
		...
		if (Constant.UPLOAD_IMAGE_WIDTH > yw && Constant.UPLOAD_IMAGE_HEIGHT > yh) {
			...
			scaledImage = scaleImage.imageZoomOut(srcBufferImage, Constant.UPLOAD_IMAGE_WIDTH, Constant.UPLOAD_IMAGE_HEIGHT);
