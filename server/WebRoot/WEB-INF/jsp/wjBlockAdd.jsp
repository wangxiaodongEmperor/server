...
.info td {
	...
	<body onload="load()">
		<form action="save.do" name="userForm" id="userForm" target="result" method="post" onsubmit="return checkInfo();">
			<input id="id" type="hidden" name="id" value="${Block4WJ.id }" />
				...
				<tr>
					<td align="left">
						<div
							...
							攻略标题：
							<input id="block" type="text" name="covertitle"
				...
				<tr>
					<td align="left">
						<div
							...
							<input id="city" type="text" name="city" value="北京" />
				...
				<tr>
					<td align="left">
						<div
							...
							<br />
							<textarea rows="5" cols="102" name="coverdescribe"
								value="${Block4WJ.coverdescribe }"></textarea>
						</div>
					</td>
				</tr>
			</table>
