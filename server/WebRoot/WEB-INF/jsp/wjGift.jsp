...
<body>
	<form action="giftCtrl.do" method="post" name="userForm" id="userForm">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="main_table">
			...
			<c:choose>
				<c:when test="${not empty list}">
					...
					<td style="text-decoration: line-through;">${item.originalprice }元</td>
		...
		<div class="page_and_btn"> 
			<div>
				<a href="javascript:addGiftAll(${blockid});" class="myBtn"><em>新增</em></a>
				<a href="javascript:goback();" class="myBtn"><em>返回</em></a>
			</div>
			<div class="page_and_btn">
				${page.pageStr }
			</div>
